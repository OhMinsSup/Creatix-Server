export const createAuthEmail = (registered: boolean, code: string) => {
  ...
  const body = `<a href="http://localhost:3000">C:</a>
      ...
      <a href="http://localhost:3000/${
        keywords.type
      }?code=${code}" style="text-decoration: none; width: 400px; text-align:center; display:block; margin: 0 auto; margin-top: 1rem; background: #22b8cf; padding-top: 1rem; color: white; font-size: 1.25rem; padding-bottom: 1rem; font-weight: 600; border-radius: 4px;">계속하기</a>
